...
c ----------------------------------------------------------------------
      ...
      REAL     GQSC, MIMCUT,  QEXT, QSCA, SPIKE,
     &         XMU(*), XX
...
c      INTRINSIC ABS, AIMAG, CMPLX, CONJG, COS, MAX, MIN, REAL, SIN
c     ..
      SAVE      PASS1
...
c     IF( XX.GT.20000.0 .OR. REAL( CREFIN ).GT.10.0 .OR.
c    &    ABS( AIMAG( CREFIN ) ).GT.10.0 )
...
c      INTRINSIC AIMAG, CMPLX, CONJG, REAL
c     ..
c     .. Statement Functions ..
